    ...
    <>
      {token ? (
        <Anchor to="/games/:pages">
          <button style={{ backgroundColor: "transparent" }} className="text-white not-italic font-medium text-2xl leading-[95.19%] bg-[#05835b00] flex flex-row justify-center items-center gap-2.5 w-60 h-[55px] p-4">
            Explore Games!
          </button>
        </Anchor>
      ) : (
