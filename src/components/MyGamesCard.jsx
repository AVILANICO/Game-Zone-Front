...
const MyGamesCard = ({ each, categories }) => {
  ...
  return (
    <div key={each._id} className='shadow-xl xsm:h-56 xsm:w-full md:w-80 md:h-52 lg:h-96 lg:w-96 mt-4 flex flex-col items-center bg-[#343434] text-white rounded-lg hover:scale-105 transition-all hover:shadow-yellow-200/50'>
