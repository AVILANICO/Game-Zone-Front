  ...
  return (
    <>
      <div className="md:pt-20">
        <div className="bg-[url(/src/assets/image/need3.jpg)] bg-no-repeat bg-cover bg-center w-fill h-[500px] rounded-md mt-[1] flex flex-col justify-center items-start pl-[10%] gap-[10px] p-0 mb-5 xsm:hidden mx-8">
