                ...
                <div className=" w-full h-auto flex flex-col justify-center items-center  xsm:h-[40vh] ">
                    <div className='my-4'>
                        <div className='rounded-2xl bg-black '>
                            <iframe className='h-[35vh] w-[30rem] cursor-none border rounded-lg' src="https://giphy.com/embed/UctoTPBIjNQaIryi6l" ></iframe>
                        </div>
                    </div>
                    <div className="rounded-[2rem] w-[90%]  bg-[#343434] xsm:w-full xsm:rounded-[4rem]">
                        <div className='flex flex-col items-center min-h-[120vh] mt-4 xsm:mt-[10%] w-[100%]'>
                            <div className='w-full flex '>
                                ...
                                <form className='flex w-full h-[5vh] justify-center' ref={category_id}>
                                    {options()}
                                </form>
                                <form className="flex rounded-lg  bg-white w-[40%] h-10 xsm:w-[90%] xsm:rounded-full xsm:mb-8 ">
                                    ...
                                    <input defaultValue={title} ref={buscador} onKeyUp={capture} type="text" placeholder=" Find your game here" id='search' className="h-full w-[100%] rounded-lg text-xl xsm:w-[70%] xsm:rounded-full outline-none" autoComplete='off' />
                                </form>
