        ...
        return (
            <div className='flex flex-row gap-2 items-center justify-center'>
                ...
                {categor?.map(a => (
                    ...
                    <div key={a._id}>
                        <label className='cursor-pointer font-bold' htmlFor={a._id} key={a._id} style={{ backgroundColor: a.hover, color: a.color, padding: '12px', borderRadius: '5px', fontSize: "18px", textAlign: "center", ...(categories.includes(a._id) ? { backgroundColor: '#155E75', color: "white", border: '1px solid black' } : {}) }}>
            ...
            {role == 3 ? (
                <div className=" w-full  flex flex-col items-center bg-[#EAEAEA]">
                    <div className=" w-full h-auto flex flex-col justify-center items-center  xsm:h-[40vh] ">
                        ...
                        <div className="rounded-[2rem] w-[90%] mt-2  bg-[#343434] xsm:w-full xsm:rounded-[4rem]">
                            <div className='flex flex-col items-center min-h-[100vh]  xsm:mt-[10%] w-[100%]'>
                                        ...
                                        <div className='flex w-[100%]'>
                                            ...
                                            <div className='flex gap-20   '>
                                                ...
                                                <div className='flex border items-center border-[#EAEAEA] ' style={{ boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.5)', borderRadius: '10px' }}>
                                                    ...
                                                    <input defaultValue={title} ref={buscador} onKeyUp={capture} type="text" placeholder=" Find the game here" id='search' className="h-full  w-[90%] rounded-lg text-xl xsm:w-[70%] xsm:rounded-full outline-none bg-[#343434]" autoComplete='off' />
                                                </div>
                                            </div>
                                ...
                                <div className='pb-[5vh] mt-20 flex xsm:flex-col xsm:items-center md:flex-wrap w-full gap-12 xsm:w-full justify-center'>
                                    {games && games.length > 0 ? (

                                        games?.map((each =>
                                            <div key={each._id} className='h-[60vh] w-[25vw]  flex flex-col items-center bg-[#16487ad2]' >
                                                <img className='w-[100%] h-[60%]' src={each.cover_photo} />
                                                <p className='md:text-[1rem] text-2xl font-bold xsm:text-center'> {each.title} </p>
                                                <div className='mt-2 w-full flex flex-col items-center'>
                                                    <p className='text-xl' style={{ color: each.category_id.color }}> {each.category_id.name}</p>
                                                    <div className='flex justify-evenly w-[100%] mt-12  flex-wrap  items-center'>
                                    ...
                                    <div className='w-[100%] flex justify-around pt-5'>
                                        ...
                                        {pagAct == 1 ? null : (<input className="bg-black hover:bg-[#2488ed30] text-white font-bold py-2 px-4 rounded-full w-[15%]" type="button" value="prev" onClick={prev} />)}
                                        {pagAct > count ? null : (<input className="bg-black hover:bg-[#2488ed30] text-white font-bold py-2 px-4 rounded-full w-[15%] " type="button" value="next" onClick={next} />)}
                                    </div>
                                </div>
                    ...
                    <div className=" w-full h-auto flex flex-col justify-center items-center  xsm:h-[40vh] ">
                        <div className=''>
                            <div className='rounded-2xl bg-black '>
                                <img src={gameon} className='h-[15rem] w-[30rem]' alt="" />
                               
                            </div>
                        </div>
                        <div className="rounded-[2rem] w-[90%]  bg-black  xsm:w-full xsm:rounded-[4rem]">
                            <div className='flex flex-col items-center min-h-[120vh] xsm:mt-[10%] w-[100%]'>
                                ...
                                <div className='pb-[5vh] flex xsm:flex-col xsm:items-center md:flex-wrap w-full gap-12 xsm:w-full justify-center'>
                                    {games && games.length > 0 ? (
                                    ...
                                    <div className='w-[100%] flex justify-around pt-5'>
                                        ...
                                        {pagAct == 1 ? null : (<input className="bg-[#2488ed88] hover:bg-[#0174DF] text-white font-bold py-2 px-4 rounded-full w-[15%]" type="button" value="prev" onClick={prev} />)}
                                        {pagAct > count ? null : (<input className="bg-[#2488ed88] hover:bg-[#0174DF] text-white font-bold py-2 px-4 rounded-full w-[15%] " type="button" value="next" onClick={next} />)}
                                    </div>
                                </div>
